            ...
            <?php echo form_open('/user/save'); ?>
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" id="password" name="password" placeholder="Senha" value="<?php echo isset($user['password']) ? $user['password'] : NULL?>">
                        </div>
                        <?php echo form_error('passwordConfirmation', '<div class="validation-error">', '</div>'); ?>
                        <div class="form-group">
                            <input type="password" class="form-control" id="passwordConfirmation" name="passwordConfirmation" placeholder="Confirme a senha" value="<?php echo isset($user['passwordConfirmation']) ? $user['passwordConfirmation'] : NULL?>">
                        </div>
                    </div>
                </div>
                <div class="panel">
                    <div class="panel-heading">
                        Informações de entrega <?php echo (trim(' ')) ? "true":"false" ?>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
